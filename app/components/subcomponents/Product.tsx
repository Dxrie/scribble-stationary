            ...
            <div className="flex w-full overflow-x-auto gap-5 scroll font-poppins">
                {isFetching || isError
                    ...
                    : data?.map((product, index) => (
                        <div
                            key={index}
                            className="w-[250px] h-[350px] flex-none relative bg-gray-300 rounded-2xl overflow-hidden flex flex-col justify-between border-gray-600 border-[0.02px] shadow-lg"
                        >
                            <div>
                                {/* Image Container */}
                            ...
                            <div className="absolute bottom-4 left-0 w-full flex items-center justify-between px-4">
                                {!match ? <Dialog>
                                    ...
                                    <DialogContent
                                        className="border-none overflow-scroll max-w-max max-h-screen scroll rounded-lg">
                                        <DialogHeader>
                                            <DialogTitle>
                                ...
                                </Dialog> : <Link href={`/product/?id=${product._id}`}><Button
                                    onClick={() => {
                                        setSelectedProduct(product);
                                        setQuantity(1);
                                    }}
